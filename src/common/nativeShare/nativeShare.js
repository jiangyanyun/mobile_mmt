 ...
 */
export default function nativeShare (elementNode, config) {
    ...
    this.init = function () {
        ...
        if ((isqqBrowser && version.qq < 5.4 ) || (isqqBrowser && version.qq < 5.3)) {
            isqqBrowser = bLevel.qq.forbid
        } else {
            if (isqqBrowser && version.qq < 5.4 ) {
                isqqBrowser = bLevel.qq.lower
            } else {
                if (isucBrowser && ((version.uc < 10.2 ) || (version.uc < 9.7 ))) {
